 const nodes = [
        ...
        // Function to highlight graph links for a group
function highlightGraphLinks(svg, nodes, links) {
...
// draw internet box
    ...
    description: "Step 6: Enter a group number to highlight multicast links.",
    action: () => {
        ...
        if (groupInput === '1') {
            ...
            alert("Invalid group number! Please enter either '1' or '2'.");
            return; // Exit if input is invalid
        }

        highlightGraphLinks(dynamicGraphSvg, nodes, groupLinks);
    }
}
